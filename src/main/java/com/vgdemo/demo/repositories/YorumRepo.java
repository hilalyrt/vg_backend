...
public interface YorumRepo extends JpaRepository<Yorum, Long> {
    List<Yorum> findByKullaniciKullaniciIdAndGonderiGonderiId(Long userId,Long postId);

    List<Yorum> findByKullaniciKullaniciId(Long userId);

    List<Yorum> findByGonderiGonderiId(Long postId);
    ...
    List<Yorum> findByKullaniciKullaniciIdAndYorumId(Long aLong, Long aLong1);
